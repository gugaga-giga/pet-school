...
export const adminApi = {
  ...
  addPackage: (data) => adminRequest.post('/admin/course/package/add', data),
  updatePackage: (data) => adminRequest.put('/admin/course/package/update', data),
  deletePackage: (id) => adminRequest.delete(`/admin/course/package/delete/${id}`),
  addPackageItem: (data) => adminRequest.post('/admin/course/package/item/add', data),
  deletePackageItem: (id) => adminRequest.delete(`/admin/course/package/item/delete/${id}`),
