  ...
  <div class="admin-layout">
    ...
    <aside class="sidebar glass" :class="{ open: sidebarOpen }">
      ...
      <nav class="sidebar-nav">
        ...
        <!-- AI Group -->
        <div class="nav-group" :class="{ expanded: aiExpanded }">
          <div class="nav-group-header" @click="aiExpanded = !aiExpanded">
            <span class="nav-group-title">🤖 AI客服</span>
            <span class="nav-group-arrow" :class="{ rotated: aiExpanded }">›</span>
          </div>
          <div class="nav-group-items" v-show="aiExpanded">
            <router-link to="/admin/ai" class="nav-item nav-sub-item">
              <span class="nav-icon">🤖</span><span class="nav-label">AI客服管理</span>
            </router-link>
          </div>
        </div>
