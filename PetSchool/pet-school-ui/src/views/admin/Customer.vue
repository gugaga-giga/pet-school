      ...
      <div class="col">
        <div class="card">
          ...
          <div class="form-actions" style="margin-top:var(--space-3)">
            <button class="btn btn-primary" style="width:100%" @click="uploadVideo" :disabled="uploading || !selectedFile">
              {{ uploading ? '上传中...' : '上传视频' }}
            </button>
          </div>
        ...
        <div class="card">
          ...
          <div class="live-actions">
            <a href="/sender.html" target="_blank" class="btn btn-accent live-btn" style="text-decoration:none">
